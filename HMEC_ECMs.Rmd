...
dt <- l3[!grepl("632|633|635|636|638|652|655|656",Barcode),]
...
dt <- dt[,Cytoplasm_PA_Gated_KRT19PositiveProportionLogitNormCOL1Median := normToCOL1Median(.SD), .SDcols=c("Cytoplasm_PA_Gated_KRT19PositiveProportionLogit","ECMp","Barcode"),by=c("Barcode")]
